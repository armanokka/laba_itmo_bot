...
func (u Users) Localize(key string, placeholders ...interface{}) string {
	...
	localization := map[string]map[string]string{
		...
		"start_info": map[string]string{
			"ar": "الآن سوف ترجمة من الروسية إلى الإنجليزية مرة أخرى. إذا كنت ترغب في تغيير لغة الكتابة /بدء\n\n\nأرسل لي رسالة وأنا سوف تترجم لهم",
			"es": "Ahora voy a traducir de Ruso a Inglés y viceversa. Si quieres cambiar el idioma, escribas /start\n\n\nEnvía me un mensaje, y me voy a traducirlas",
			"en": "Now I will translate from Russian to English and back again. If you want to change languages, write /start\n\n\nSend me messages, and I'll translate them",
			"ru": "Теперь я буду переводить с Русский на Английский и обратно. Если захочешь сменить языки, напишешь /start\n\n\nОтправляй мне сообщения, а я буду их переводить",
			"id": "Sekarang saya akan menerjemahkan dari rusia ke inggris dan kembali lagi. Jika anda ingin mengubah bahasa, menulis /memulai\n\n\nMengirim saya pesan, dan saya akan menerjemahkannya",
			"it": "Ora ho intenzione di tradurre dal Russo all'Inglese e viceversa. Se vuoi cambiare le lingue, scrivi /start\n\n\nMi mandare messaggi, e io sarò loro di tradurre",
			"uz": "Endi men rus tilidan ingliz tiliga va orqaga tarjima qilaman. Agar tillarni o'zgartirishni xohlasangiz, yozing / boshlang\n\n\nMenga xabar yuboring va men ularni tarjima qilaman",
			"uk": "Тепер я буду перекладати Російську на Англійську і назад. Якщо захочеш змінити мови, напишеш /start\n\n\nВідправляй мені повідомлення, а я буду їх переказувати",
			"de": "Jetzt werde ich das übersetzen von Russisch nach Englisch und Umgekehrt. Wenn Sie möchten ändern die Sprachen, schreiben /start\n\n\nSenden Sie mir eine Nachricht, ich werden Sie zu übersetzen",
			"pt": "Agora eu vou traduzir do Russo para o Inglês e para trás. Se quiseres mudar de línguas, irmão /start\n\n\nОтправляй-me mensagens, e eu serei o seu traduzir",
		},
