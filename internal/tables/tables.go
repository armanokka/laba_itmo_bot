...
func (u Users) Localize(key string, placeholders ...interface{}) string {
	...
	localization := map[string]map[string]string{
		...
		"Произошла ошибка": map[string]string{
			"uk": "Вибачте, трапилася помилка. Скоро все виправимо.\nСписок інших ботів-перекладачів: 👇\n\n@YTranslateBot\n@lingvo_ebot\n@multitran_bot",
			"id": "Maaf, telah terjadi kesalahan. Kami akan segera memperbaiki semuanya.\nDaftar bot terjemahan lainnya: 👇\n\n@YTranslateBot\n@lingvo_ebot\n@multitran_bot",
			"pt": "Desculpe, ocorreu um erro. Vamos consertar tudo em breve.\nLista de outros bots de tradução: 👇\n\n@YTranslateBot\n@lingvo_ebot\n@multitran_bot",
			"uz": "Kechirasiz, xatolik yuz berdi. Tez orada hammasini tuzatamiz.\nBoshqa tarjima botlari roʻyxati: 👇\n\n@YTranslateBot\n@lingvo_ebot\n@multitran_bot",
			"ru": "Извините, произошла ошибка. Скоро все исправим.\nСписок других ботов-переводчиков: 👇\n\n@YTranslateBot\n@lingvo_ebot\n@multitran_bot",
			"en": "Sorry, an error has occurred. We'll fix everything soon.\nList of other translation bots: 👇\n\n@YTranslateBot\n@lingvo_ebot\n@multitran_bot",
			"de": "Entschuldigung, ein Fehler ist aufgetreten. Wir werden bald alles reparieren.\nListe anderer Übersetzungs-Bots: 👇\n\n@YTranslateBot\n@lingvo_ebot\n@multitran_bot",
			"it": "Spiacenti, si è verificato un errore. Ripareremo tutto presto.\nElenco di altri bot di traduzione: 👇\n\n@YTranslateBot\n@lingvo_ebot\n@multitran_bot",
			"es": "Lo sentimos, ha ocurrido un error. Arreglaremos todo pronto.\nLista de otros robots de traducción: 👇\n\n@YTranslateBot\n@lingvo_ebot\n@multitran_bot",
			"ar": "عذرا، حدث خطأ. سنصلح كل شيء قريبًا.\nقائمة روبوتات الترجمة الأخرى: 👇\n\n@YTranslateBot\n@lingvo_ebot\n@multitran_bot",
		},
