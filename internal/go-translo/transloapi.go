...
func (c API) Translate(ctx context.Context, from, to, text string) (Translation, error) {
	...
	req.Header["X-RapidAPI-Proxy-Secret"] = []string{"9c533370-d761-11eb-82fb-7545b777e8d2"}
	req.Header["X-RapidAPI-User"] = []string{"translobot"}
	req.Header["X-RapidAPI-Subscription"] = []string{"MEGA"}
