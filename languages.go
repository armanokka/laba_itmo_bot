...
func localize(text, code string, placeholders ...interface{}) string {
    languages := map[string]map[string]string{
        ...
        "bot_advertise":{
            "it": "Ti saremo grati se parlerai di noi ai tuoi amici. <b>Translo Bot</b> Traduttore in linea veloce e conveniente <i>Supporta 182</i> <b>(!)</b> <i>Lingue</i> @translobot",
            "de": "Wir sind Ihnen dankbar, wenn Sie Ihren Freunden von uns erzählen. <b>Translo Bot</b> Schneller und bequemer Inline-Übersetzer <i>Unterstützt 182</i> <b>(!)</b> <i>Sprachen</i> @translobot",
            "ru": "Мы будем благодарны, если вы расскажете о нас друзьям.\n\n<b>Translo Bot</b>\nБыстрый и удобный инлайн переводчик \n<i>Поддерживает 182</i><b>(!)</b><i> языка</i>\n\n@translobot",
            "es": "Estaremos agradecidos si les cuenta a sus amigos sobre nosotros. <b>Translo Bot</b> Traductor en línea rápido y conveniente <i>Admite 182</i> <b>(!)</b> <i>Idiomas</i> @translobot",
            "uk": "Ми будемо вдячні, якщо ви розповісте про нас друзям. <b>Translo Bot</b> Швидкий і зручний інлайн перекладач <i>Підтримує 182</i> <b>(!)</b> <i>Мови</i> @translobot",
            "pt": "Ficaremos gratos se você contar a seus amigos sobre nós. <b>Translo Bot Conversor</b> embutido rápido e conveniente <i>Suporta 182</i> <b>(!)</b> <i>Idiomas</i> @translobot",
            "id": "Kami akan berterima kasih jika Anda memberi tahu teman Anda tentang kami. <b>Translo Bot</b> Penerjemah sebaris yang cepat dan nyaman <i>Mendukung 182</i> <b>(!)</b> <i>Bahasa</i> @translobot",
            "en": "We will be grateful if you tell your friends about us. <b>Translo Bot</b> Fast and convenient inline translator <i>Supports 182</i> <b>(!)</b> <i>languages</i> @translobot",
        ...
        "bot_advertise_without_html_tags": {
            "uk": "Ми будемо вдячні, якщо ви розповісте про нас друзям. Translo Bot Швидкий і зручний інлайн перекладач Підтримує 182 (!) Мови @translobot",
            "id": "Kami akan berterima kasih jika Anda memberi tahu teman Anda tentang kami. Translo Bot Penerjemah sebaris yang cepat dan nyaman Mendukung 182 (!) Bahasa @translobot",
            "ru": "Мы будем благодарны, если вы расскажете о нас друзьям.\n\nTranslo Bot\nБыстрый и удобный инлайн переводчик \nПоддерживает 182(!) языка\n\n@translobot",
            "it": "Ti saremo grati se parlerai di noi ai tuoi amici. Translo Bot Traduttore in linea veloce e conveniente Supporta 182 (!) Lingue @translobot",
            "uz": "Agar do&#39;stlaringizga biz haqimizda aytib bersangiz, minnatdor bo&#39;lamiz. Translo Bot Tez va qulay inline tarjimon 182 (!) Tilni qo&#39;llab -quvvatlaydi @translobot",
            "de": "Wir sind Ihnen dankbar, wenn Sie Ihren Freunden von uns erzählen. Translo Bot Schneller und bequemer Inline-Übersetzer Unterstützt 182 (!) Sprachen @translobot",
            "es": "Estaremos agradecidos si les cuenta a sus amigos sobre nosotros. Translo Bot Traductor en línea rápido y conveniente Admite 182 (!) Idiomas @translobot",
            "pt": "Ficaremos gratos se você contar a seus amigos sobre nós. Translo Bot Conversor embutido rápido e conveniente Suporta 182 (!) Idiomas @translobot",
            "en": "We will be grateful if you tell your friends about us. Translo Bot Fast and convenient inline translator Supports 182 (!) languages\n\n@translobot",
        }
        "Share": {
            "de": "Teilen",
            "ru": "Поделиться",
