...
func localize(text, code string, placeholders ...interface{}) string {
    languages := map[string]map[string]string{
        ...
        "/help": map[string]string{
            "es": "¿Qué puede hacer este bot? ▫️ Translo se traduce a más de 182 idiomas. ¿Cómo traduzco mensajes? ▫️ Establezca su idioma y el idioma de destino, luego simplemente comience a escribirme mensajes y los traduciré de su idioma al idioma de destino y viceversa. ¿Qué traductor utilizas? ▫️ Usamos este https://bit.ly/3oqC6Rf ¡Tengo sugerencias o encontré un error! ▫️ Contáctame: @armanokka También prueba nuestro modo integrado :)",
            "id": "Apa yang bisa dilakukan bot ini? ️ Translo diterjemahkan ke dalam 182+ bahasa. Bagaimana cara menerjemahkan pesan? ️ Atur bahasa dan bahasa target Anda, lalu mulailah menulis pesan kepada saya dan saya akan menerjemahkannya dari bahasa Anda ke bahasa target dan sebaliknya. Penerjemah apa yang Anda gunakan? ️ Kami menggunakan ini https://bit.ly/3oqC6Rf Saya punya saran atau saya menemukan bug! ️ Hubungi saya: @armanokka Coba juga mode bawaan kami :)",
            "it": "Cosa può fare questo bot? ▫️ Translo traduce in oltre 182 lingue. Come traduco i messaggi? ▫️ Imposta la tua lingua e la lingua di destinazione, quindi inizia a scrivermi messaggi e io li tradurrò dalla tua lingua alla lingua di destinazione e viceversa. Che traduttore usi? ▫️ Usiamo questo https://bit.ly/3oqC6Rf Ho dei suggerimenti o ho trovato un bug! ▫️ Contattami: @armanokka Prova anche la nostra modalità integrata :)",
            "uz": "Bu bot nima qila oladi? ▫️ Translo 182 dan ortiq tillarga tarjima qilinadi. Xabarlarni qanday tarjima qilaman? ▫️ Tilingizni va maqsadli tilingizni belgilang, keyin menga xabar yozishni boshlang, men ularni sizning tilingizdan maqsadli tilga va aksincha tarjima qilaman. Siz qaysi tarjimondan foydalanasiz? ▫️ Biz buni ishlatamiz https://bit.ly/3oqC6Rf Menda takliflar bor yoki men xato topdim! ▫️ Men bilan bog'laning: @armanokka Shuningdek, bizning o'rnatilgan rejimimizni ham ko'ring :)",
            "de": "Was kann dieser Bot tun? ▫️ Translo übersetzt in mehr als 182 Sprachen. Wie übersetze ich Nachrichten? ▫️ Stellen Sie Ihre Sprache und Zielsprache ein, dann schreiben Sie mir einfach Nachrichten und ich übersetze sie von Ihrer Sprache in die Zielsprache und umgekehrt. Welchen Übersetzer verwenden Sie? ▫️ Wir verwenden diese https://bit.ly/3oqC6Rf Ich habe Vorschläge oder ich habe einen Fehler gefunden! ▫️ Kontaktiere mich: @armanokka Probiere auch unseren eingebauten Modus aus :)",
            "pt": "O que esse bot pode fazer? ▫️ Translo se traduz em mais de 182 idiomas. Como faço para traduzir mensagens? ▫️ Defina o seu idioma e o idioma de chegada e, em seguida, comece a escrever mensagens para mim e eu irei traduzi-las do seu idioma para o idioma de destino e vice-versa. Qual tradutor você usa? ▫️ Usamos este https://bit.ly/3oqC6Rf Tenho sugestões ou encontrei um bug! ▫️ Contate-me: @armanokka Experimente também nosso modo integrado :)",
            ...
            "ru": "Что умеет этот бот? ▫️ Translo переводится на 182+ языков. Как мне переводить сообщения? ▫️ Установите свой язык и целевой язык, а затем просто начните писать мне сообщения, и я переведу их с вашего языка на целевой и наоборот. Каким переводчиком вы пользуетесь? ▫️ Мы используем https://bit.ly/3oqC6Rf У меня есть предложения или я обнаружил ошибку! ▫️ Свяжитесь со мной: @armanokka Также попробуйте наш встроенный режим :)",
            "uk": "Що може зробити цей бот? Lo️ Translo перекладається на 182+ мов. Як перекласти повідомлення? ️ Встановіть свою мову та мову перекладу, а потім просто почніть писати мені повідомлення, і я перекладу їх з вашої мови на цільову та навпаки. Яким перекладачем ви користуєтесь? ▫️ Ми використовуємо цей https://bit.ly/3oqC6Rf У мене є пропозиції або я знайшов помилку! ️ Зв’яжіться зі мною: @armanokka Також спробуйте наш вбудований режим :)",
        },
