...
func localize(text, code string, placeholders ...interface{}) string {
    languages := map[string]map[string]string{
        ...
        "/help": map[string]string{
            ...
            "uz": "Bu bot nima qila oladi?\n▫️ Translo 182 dan ortiq tillarga tarjima qilinadi.\n\nXabarlarni qanday tarjima qilaman?\n▫️ Tilingizni va maqsadli tilingizni belgilang, keyin menga xabar yozishni boshlang, men ularni sizning tilingizdan maqsadli tilga va aksincha tarjima qilaman.\n\nShuningdek, bizning o'rnatilgan rejimimizni sinab ko'ring 👇",
